...
export type Screen = 'board' | 'dashboard' | 'cases' | 'settings' | 'autoHistory' | 'backtest' | 'liquidityZones';
...
export const useStore = create<StoreState>((set, get) => ({
  ...
  screen: ((): Screen => {
    ...
    return (['board', 'cases', 'autoHistory', 'dashboard', 'settings', 'backtest', 'liquidityZones'] as const).includes(h as Screen)
      ? h as Screen
      : 'board';
  })(),
  chartModal: null,
