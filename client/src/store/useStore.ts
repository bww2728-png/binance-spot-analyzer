...
export type Screen = 'board' | 'dashboard' | 'cases' | 'settings' | 'autoHistory' | 'backtest';
...
export const useStore = create<StoreState>((set, get) => ({
  ...
  screen: ((): Screen => {
    ...
    return (['board', 'cases', 'autoHistory', 'dashboard', 'settings', 'backtest'] as const).includes(h as Screen)
      ? h as Screen
      : 'board';
  })(),
  chartModal: null,
